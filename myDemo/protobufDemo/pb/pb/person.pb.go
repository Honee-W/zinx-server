...
type Person struct {
	...
	Emails []string       `protobuf:"bytes,3,rep,name=emails,proto3" json:"emails,omitempty"` //repeated 字段可重复 对应go的切片
...
var file_person_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x0a, 0x04, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f,
